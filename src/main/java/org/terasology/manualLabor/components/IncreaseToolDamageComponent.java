...
/**
 * Add this to a substance so that when a tool is created, its base damage is increased based on how much of the
...
public class IncreaseToolDamageComponent implements Component, ToolModificationDescription {
    ...
    public String getDescription() {
        ...
        return String.format(upDown + " tool damage by %.1f for every 100 units of material",
                Math.abs(increasePerSubstanceAmount * 100f));
    }
}
