...
public class ToolItemOutputProcessPartCommonSystem extends BaseComponentSystem {
    ...
    private Set<EntityRef> createOutputItems(EntityRef processEntity, ToolItemOutputComponent toolItemOutputComponent) {
        ...
        InventoryInputItemsComponent inventoryInputItemsComponent =
                processEntity.getComponent(InventoryInputItemsComponent.class);
        if (inventoryInputItemsComponent != null) {
            for (EntityRef itemInSlot : inventoryInputItemsComponent.items) {
                ...
                MaterialCompositionComponent itemMaterialCompositionComponent =
                        itemInSlot.getComponent(MaterialCompositionComponent.class);
                if (materialItemComponent != null && itemMaterialCompositionComponent != null) {
                    iconSubstanceMap.put(materialItemComponent.icon,
                            itemMaterialCompositionComponent.getPrimarySubstance());
                }
            }
    ...
    public void tweakToolEntityIcon(EntityRef toolEntity, Map<String, String> iconSubstanceMap) {
        ...
        // if we did not match up this overlay item to an item, and the hue was previously set, use the overall 
        // substance to tint
